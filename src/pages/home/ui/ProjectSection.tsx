  ...
  return (
    <Carousel
      ...
      renderItem={(item) => {
        ...
        return (
          <motion.div whileHover={{ y: -24, scale: 1.05 }} transition={{ duration: 0.4 }} className="group relative h-75 w-75 shrink-0 cursor-pointer overflow-hidden rounded-xl sm:h-120 sm:w-125">
